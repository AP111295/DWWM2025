...
entries.forEach((entry) => {
    if(entry.isIntersecting){       /* -----1st way of adding getBoundingclientrect------ */
        console.log(entry);
...
const observering = new IntersectionObserver(callback, p);
...
const observer2 = new IntersectionObserver(newfunction, {rootMargin:"200px"})
observer2.observe(lastp); 
    
function newfunction(entry){
...
/* -----2nd way of adding getBoundingclientrect------ */
// const ps = document.querySelector("p");

// window.addEventListener("scroll", function (){
//     // console.log(window.innerHeight);
//     // console.log(ps.getBoundingClientRect().top);
//     if(ps.getBoundingClientRect().top < window.innerHeight)
//     {
//         ps.style.visibility = "visible";
//         ps.style.backgroundColor = "pink";
//     }
// });
