...
/* 
    ...
    For example, a small poll about your favorite fruit which hides invisible fields and when submitted, 
    sends the request to a site you control to submit a form accessible only to you.

    To protect against this, we generate a random token (a sequence of letters and numbers) saved in the session and 
    included in a hidden field in the form.
